...
public class Stays2 {
    ...
    public Stays2(String Name,String Mail,char Gender,String Pass,int TotalnumberofAdults, int TotalnumberofChildren, String ArrivalDate,String DepartureDate
    ){
    this.Name = Name;
    this.Mail = Mail;
    this.Gender = Gender;
    ...
    public Stays2(int StaysID,String Name,String Mail,char Gender,String Pass,int TotalnumberofAdults, int TotalnumberofChildren, String ArrivalDate,String DepartureDate){
