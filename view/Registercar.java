...
public class Registercar extends JFrame implements ActionListener{
         ...
         private void registercar(){
             ...
             //String Arrival= cb1.getSelectedItem().toString();
             String Departure = (String)cb3.getSelectedItem()+" "+(String)cb4.getSelectedItem();
             carcontroller = new Carcontroller();
             Car car = new Car(start,end,Arrival,Departure);
             int insert = carcontroller.registercar(car);
